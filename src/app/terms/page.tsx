...
export default function Terms() {
    return (
        <div className={styles.terms}>
            <h2 className={styles.terms_title}>
                <strong>Terms and Conditions</strong>
            </h2>

            <p>Welcome to Booklify!</p>

            <p>
                These terms and conditions outline the rules and regulations for the use of Booklify.pl&apos;s
                Website, located at https://www.booklify.pl.
            </p>

            <p>
                By accessing this website we assume you accept these terms and conditions. Do not continue to
                use Booklify if you do not agree to take all of the terms and conditions stated on this page.
            </p>
            ...
            <p>
                ...
                accordance with and subject to, prevailing law of pl. Any use of the above terminology or
            ...
            <p>
                We employ the use of cookies. By accessing Booklify, you agreed to use cookies in agreement
                with the Booklify.pl&apos;s Privacy Policy.{" "}
            </p>
            ...
            <p>
                Unless otherwise stated, Booklify.pl and/or its licensors own the intellectual property rights
                for all material on Booklify. All intellectual property rights are reserved. You may access
                this from Booklify for your own personal use subjected to restrictions set in these terms and
                conditions.
            </p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Booklify</li>
                <li>Sell, rent or sub-license material from Booklify</li>
                <li>Reproduce, duplicate or copy material from Booklify</li>
                <li>Redistribute content from Booklify</li>
            </ul>
            ...
            <p>
                ...
                information in certain areas of the website. Booklify.pl does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments do not reflect the views and
                opinions of Booklify.pl,its agents and/or affiliates. Comments reflect the views and opinions
                of the person who post their views and opinions. To the extent permitted by applicable laws,
                Booklify.pl shall not be liable for the Comments or for any liability, damages or expenses
                caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
                Comments on this website.
            </p>

            <p>
                Booklify.pl reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>
                You hereby grant Booklify.pl a non-exclusive license to use, reproduce, edit and authorize
            ...
            <p>
                ...
                visibility of the hyperlink compensates the absence of Booklify.pl; and (d) the link is in the
            ...
            <p>
                ...
                to our website, you must inform us by sending an e-mail to Booklify.pl. Please include your
            ...
            <p>
                No use of Booklify.pl&apos;s logo or other artwork will be allowed for linking absent a
