...
export default function Privacy() {
    return (
        <div className={styles.privacy}>
            <h1 className={styles.privacy_title}>Privacy Policy</h1>
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Booklify, accessible from{" "}
                        <a
                            href="https://www.booklify.pl"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://www.booklify.pl
                        </a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: kushichka@gmail.com</li>
            </ul>
        </div>
    );
}
